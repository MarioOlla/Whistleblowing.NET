...
namespace Whistleblowing.NETAPI.Migrations
{
    ...
    [Migration("20250108094657_migrazioneSA")]
    partial class migrazioneSA
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Whistleblowing.NETAPI.Models.PaginatedSegnalazioniAnonimeViewModel", b =>
                {
                    b.Property<DateTime?>("DataEvento")
                        .HasColumnType("datetime2")
                        .HasColumnName("data_evento");

                    b.Property<int?>("Id_segnalazioneAnonima")
                        .HasColumnType("int")
                        .HasColumnName("segnalazione_anonima_id");
                    ...
                    b.ToView("PaginatedSegnalazioniAnonimeViewModel", (string)null);
                });

            modelBuilder.Entity("Whistleblowing.NETAPI.Models.PaginatedSegnalazioniRegularViewModel", b =>
                {
                    b.Property<DateTime?>("DataEvento")
                        .HasColumnType("datetime2")
                        .HasColumnName("DataEvento");

                    b.Property<int?>("Id_segnalazioneRegular")
                        .HasColumnType("int")
                        .HasColumnName("Id_segnalazioneRegular");
                    ...
                    b.Property<string>("SoggettoColpevole")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("SoggettoColpevole");

                    b.ToTable((string)null);

                    b.ToView("PaginatedSegnalazioniRegularViewModel", (string)null);
                });
            ...
            modelBuilder.Entity("Whistleblowing.NETAPI.Models.view.PaginatedSegnalazioniAnonimeViewUtente", b =>
                {
                    b.Property<DateTime?>("DataEvento")
                        .HasColumnType("datetime2")
                        .HasColumnName("data_evento");
                    ...
                    b.Property<int?>("segnalazione_anonima_id")
                        .HasColumnType("int")
                        .HasColumnName("segnalazione_anonima_id");

                    b.ToTable((string)null);

                    b.ToView("PaginatedSegnalazioniAnonimeViewUtente", (string)null);
                });

            modelBuilder.Entity("Whistleblowing.NETAPI.Models.view.PaginatedSegnalazioniRegularViewUtente", b =>
                {
                    b.Property<DateTime?>("DataEvento")
                        .HasColumnType("datetime2")
                        .HasColumnName("data_evento");
                    ...
                    b.Property<int?>("segnalazione_regular_id")
                        .HasColumnType("int")
                        .HasColumnName("segnalazione_regular_id");

                    b.ToTable((string)null);

                    b.ToView("PaginatedSegnalazioniRegularViewUtente", (string)null);
                });

            modelBuilder.Entity("Whistleblowing.NETAPI.Models.view.SegnalazioneAnonimaView", b =>
                {
                    b.Property<string>("AmmontarePagamentoOAltraUtilita")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("ammontare_pagamento_o_altra_utilita");
                    ...
                    b.ToView("SegnalazioneAnonimaView", (string)null);
                });
            ...
            modelBuilder.Entity("Whistleblowing.NETAPI.Models.view.SegnalazioneRegularView", b =>
                {
                    b.HasOne("Whistleblowing.NETAPI.Models.User", "user")
                        .WithMany()
